...
export default function Hero() {
  return (
    <section id="hero" className="relative w-full bg-white pt-[5.5rem] pb-8 px-4 md:px-8 h-screen min-h-[750px] flex">
      {/* Inner container mimicking the dark 'screen' */}
      <div className="relative w-full h-full bg-[#0d0d0d] rounded-[2rem] overflow-hidden flex flex-col justify-center">
        ...
        {/* Main Text */}
        <div className="relative z-10 px-8 md:px-20 max-w-4xl mt-[-40px]">
          <h1 className="text-[2.5rem] md:text-[4rem] leading-[1.1] font-semibold text-white tracking-tight mb-6 mt-4">
        ...
        <div className="absolute bottom-0 left-0 z-20">
          <div className="bg-white rounded-tr-3xl px-8 py-5 flex items-center justify-center gap-6">
            ...
            <a href="#" className="text-gray-900 hover:text-blue-600 transition">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"/></svg>
            </a>
            <a href="#" className="text-gray-900 hover:text-blue-600 transition">
